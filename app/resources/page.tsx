...
export default function ResourcesPage() {
  ...
  function generateLLMS() {
    ...
    let out = `# llms.txt — generated by AEOvision\n# Place at: https://${d}/llms.txt\n# Generated: ${new Date().toISOString().split('T')[0]}\n\n# ── Site Information ──\nName: ${name||'Your Site'}\n`
    ...
    <>
      ...
      <div style={{background:'var(--bg)',minHeight:'100vh',color:'var(--text)',fontFamily:"'Epilogue',sans-serif"}}>
            ...
            <div className="fade">
              ...
              <div style={{display:'grid',gridTemplateColumns:'220px 1fr',gap:'4rem',padding:'4rem 0 6rem',alignItems:'start'}}>
                ...
                <div className="prose">
                  ...
                  <p>The fastest way to improve your AEO score is to identify which queries your competitors get cited for that you do not. AEOvision's content gap analysis runs the same prompt set against your domain and competitor domains and returns a sorted list of citation opportunities ranked by search volume and commercial intent.</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="fade">
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'2rem',padding:'4rem 0 6rem',alignItems:'start'}}>
                ...
                <div style={{background:'var(--card)',border:'1px solid var(--border)',borderRadius:'14px',padding:'2rem',display:'flex',flexDirection:'column',gap:'1.25rem'}}>
                  ...
                  {[{id:'name',label:'Site name',placeholder:'AEOvision'},{id:'domain',label:'Domain',placeholder:'aeovision.com'},{id:'desc',label:'Description (optional)',placeholder:'AI visibility platform for SEO professionals'},{id:'email',label:'Contact email (optional)',placeholder:'hello@yourdomain.com'}].map(f=>(
          ...
          {page==='about' && (
            <div className="fade">
              <div style={{padding:'6rem 0 4rem',borderBottom:'1px solid var(--border)'}}>
                ...
                <p style={{fontSize:'1.05rem',color:'var(--muted)',lineHeight:1.75,maxWidth:'520px'}}>AEOvision started as an internal tool for a small SEO team trying to understand why some clients showed up in AI answers and others didn't.</p>
              </div>
                ...
                <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'3rem'}}>
                  ...
                  <div>
                    ...
                    <div style={{background:'var(--card)',border:'1px solid var(--border)',borderRadius:'12px',padding:'1.75rem'}}>
                      <p style={{fontSize:'.9rem',color:'var(--muted)',lineHeight:1.75,marginBottom:'1rem'}}>AEOvision is bootstrapped and profitable. We are not venture-backed. This means we build for our users, not for a growth-at-all-costs exit timeline.</p>
          ...
          {page==='privacy' && (
            <div className="fade">
              ...
              <div style={{display:'grid',gridTemplateColumns:'220px 1fr',gap:'4rem',padding:'4rem 0 6rem',alignItems:'start'}}>
                ...
                <div className="prose">
                  <p>AEOvision ("we", "our", "us") is committed to protecting your personal information. This policy explains what data we collect, why we collect it, and how you can control it.</p>
                  <h2 id="p1">1. Information we collect</h2>
                  <p>We collect the following categories of information when you use AEOvision.</p>
                  ...
                  <p>We use your data only to provide and improve the AEOvision service.</p>
                  ...
                  <div className="callout"><p>We do not sell your data. We do not share it with advertisers. We do not use it for any purpose outside of operating the AEOvision service.</p></div>
                  ...
                  <p>Under GDPR and equivalent regulations, you have the right to access, correct, export, or delete your data at any time. Email <a href="mailto:privacy@aeovision.com" style={{color:'var(--accent)'}}>privacy@aeovision.com</a>.</p>
                  ...
                  <p>All data is transmitted over HTTPS. Passwords are hashed using bcrypt. Database access is restricted to AEOvision infrastructure only. We conduct regular security reviews.</p>
                  <h2 id="p8">8. Contact us</h2>
                  <p>For privacy-related questions, contact us at <a href="mailto:privacy@aeovision.com" style={{color:'var(--accent)'}}>privacy@aeovision.com</a>.</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="fade">
              ...
              <div style={{display:'grid',gridTemplateColumns:'220px 1fr',gap:'4rem',padding:'4rem 0 6rem',alignItems:'start'}}>
                ...
                <div className="prose">
                  ...
                  <p>By accessing or using AEOvision, you agree to be bound by these Terms of Service. If you do not agree, do not use the service.</p>
                  <h2 id="t2">2. Service description</h2>
                  <p>AEOvision provides AI visibility analysis, AEO scoring, and related tools. We reserve the right to modify or discontinue any part of the service with reasonable notice.</p>
                  ...
                  <p>You may not use AEOvision to scan domains you do not own or have permission to analyse, to attempt to reverse-engineer our scoring algorithms, to resell or redistribute data without a written agreement, or to violate any applicable laws.</p>
                  ...
                  <p>AEOvision is provided "as is" without warranties of any kind. We do not guarantee specific outcomes such as citation increases or traffic improvements.</p>
                  <h2 id="t8">8. Limitation of liability</h2>
                  <p>To the maximum extent permitted by law, AEOvision's liability for any claim is limited to the amount you paid us in the 12 months preceding the claim.</p>
            ...
            <div className="fade">
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'4rem',padding:'4rem 0 6rem',alignItems:'start'}}>
                ...
                <div style={{display:'flex',flexDirection:'column',gap:'1.25rem'}}>
                  {[{icon:'✉️',title:'Email',val:'hello@aeovision.com',sub:'We reply within 24 hours.'},{icon:'💬',title:'Live chat',val:'Available on the dashboard',sub:'Pro and Agency plan users get priority support.'},{icon:'🐦',title:'Twitter / X',val:'@aeovision',sub:'For product updates and quick questions.'}].map((c,i)=>(
        ...
        <div style={{borderTop:'1px solid var(--border)',padding:'1.4rem 3.5rem',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
          <span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:'.63rem',color:'var(--muted2)',letterSpacing:'.04em'}}>© 2026 <span style={{color:'var(--muted)'}}>AEOvision</span> — AI Visibility Intelligence Platform</span>
