  ...
  return (
    <>
      <JsonLd schema={toolPageSchema(
        { name: 'llms.txt Generator', description: 'Generate a correctly formatted llms.txt file in seconds, pre-configured to allow GPTBot, PerplexityBot, ClaudeBot, and Google-Extended.', abstract: 'One-click llms.txt generation — pre-configured for all major AI crawlers.', featureList: ['GPTBot allow/disallow configuration','PerplexityBot declaration','ClaudeBot configuration','Google-Extended configuration','robots.txt conflict check'], path: '/llms-text-generator' },
        [],
        [{ name: 'llms.txt Generator', path: '/llms-text-generator' }],
      )} />
      <style>{css}</style>
