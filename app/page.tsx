...
<section id="fix" style={{padding:'7rem 3.5rem',maxWidth:'1320px',margin:'0 auto'}}>
  <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-end',marginBottom:'3rem',flexWrap:'wrap',gap:'2rem'}}>
    ...
    <p style={{fontSize:'1rem',color:'var(--muted)',lineHeight:1.75,maxWidth:'480px'}}>AEOvision doesn't just surface problems. Every issue comes with a one-click fix, a before/after preview, and an estimated citation impact so you know what to prioritise first.</p>
  </div>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 60px 1fr',gap:0,marginBottom:'1.25rem',alignItems:'stretch'}}>
        ...
        <div style={{display:'flex',flexDirection:'column'}}>
          <div style={{padding:'.55rem .9rem',fontFamily:"'JetBrains Mono',monospace",fontSize:'.63rem',letterSpacing:'.07em',display:'flex',alignItems:'center',gap:'.5rem',borderRadius:'8px 8px 0 0',border:'1px solid rgba(74,222,128,.2)',background:'rgba(74,222,128,.06)',color:'#4ade80'}}>
            <span style={{width:'7px',height:'7px',borderRadius:'50%',background:'#4ade80',display:'inline-block'}} />After — AEOvision generated
          </div>
          <div style={{flex:1,border:'1px solid rgba(74,222,128,.2)',borderTop:'none',borderRadius:'0 0 8px 8px',padding:'1rem',background:'rgba(74,222,128,.03)'}}>
            <pre style={{fontFamily:"'JetBrains Mono',monospace",fontSize:'.72rem',lineHeight:1.8,color:'var(--muted)'}}>
              <span style={{color:'var(--muted2)'}}># llms.txt — generated by AEOvision{'\n'}</span>
...
<section id="eeat" style={{padding:'7rem 3.5rem',maxWidth:'1320px',margin:'0 auto'}}>
  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'5rem',alignItems:'center'}}>
    <div>
      ...
      <p style={{fontSize:'1rem',color:'var(--muted)',lineHeight:1.75,maxWidth:'480px',marginBottom:'2.5rem'}}>Every major LLM uses authority signals to decide whose content to cite. AEOvision audits all four pillars of E-E-A-T and scores how you appear to AI crawlers.</p>
...
<section id="results" style={{padding:'7rem 3.5rem',maxWidth:'1320px',margin:'0 auto'}}>
  ...
  <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'1rem',marginBottom:'4rem'}}>
    {[
      ...
      {tag:'EdTech · International',tagC:'var(--cyan)',tagBC:'rgba(34,211,238,.2)',tagBg:'rgba(34,211,238,.06)',quote:'"We manage SEO for 35 global education domains. AEOvision gave us the first clear picture of which domains were being cited by Gemini and which weren\'t — it changed how we briefed content teams in every region."',initials:'AM',gradC:'linear-gradient(135deg,#4285f4,var(--cyan))',name:'Arun Mehta',role:'Head of SEO · Global Education Group',metric:'35',metricL:'Domains tracked'},
      {tag:'Agency · Multi-client',tagC:'var(--rose)',tagBC:'rgba(244,114,182,.2)',tagBg:'rgba(244,114,182,.06)',quote:'"Every client asks about AI search now. AEOvision lets me show them a score on day one, a fix list by day three, and measurable citation growth in the monthly report. It\'s become a core part of our SEO audits."',initials:'PK',gradC:'linear-gradient(135deg,var(--rose),#fb923c)',name:'Priya Kapoor',role:'Founder · Digital Growth Agency',metric:'18',metricL:'Client accounts'},
    ].map((c,i)=>(
