...
export const metadata = {
  title: 'The Complete AEO Guide 2026 — Notion Cue 100% 🅵🆁🅴🅴 Tool',
  description: 'Everything you need to understand Answer Engine Optimisation and get your content cited by ChatGPT, Gemini, Perplexity, and every major LLM.',
  openGraph: {
    title: 'The Complete AEO Guide 2026 — Notion Cue 100% 🅵🆁🅴🅴 Tool',
    description: 'Learn how to get your content cited by AI engines. BLUF structure, schema markup, llms.txt, E-E-A-T signals and more.',
    type: 'article',
  },
}
  ...
  return (
    <>
      ...
      <div style={{background:'var(--bg)',minHeight:'100vh',color:'var(--text)'}}>
        ...
        {/* Sub-nav — client island for active highlighting */}
        <SubNavClient />
        ...
        <div style={{maxWidth:'1200px',margin:'0 auto',padding:'0 3.5rem'}}>
          ...
          <div style={{padding:'6rem 0 4rem',borderBottom:'1px solid var(--border)'}}>
            ...
            <p style={{fontSize:'1.05rem',color:'var(--muted)',lineHeight:1.75,maxWidth:'520px'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'220px 1fr',gap:'4rem',padding:'4rem 0 6rem',alignItems:'start'}}>
            ...
            {/* Table of contents — pure static HTML, no JS */}
            <div style={{position:'sticky',top:'120px'}}>
              <div style={{background:'var(--card)',border:'1px solid var(--border)',borderRadius:'12px',padding:'1.4rem'}}>
                ...
                {[
                  ['#g1','What is AEO?'],
                  ['#g2','How LLMs select sources'],
                  ['#g3','The AEO scoring model'],
                  ['#g4','BLUF content structure'],
                  ['#g5','Schema markup for AI'],
                  ['#g6','llms.txt setup'],
                  ['#g7','E-E-A-T for LLMs'],
                  ['#g8','Competitor analysis'],
                ].map(([h,l])=>(
            ...
            {/* Article content — all static HTML for Google */}
